var frt_spots = {
	'spots':[
	{
		'hover': '<u><b>EXAMPLE "B"</b></u><br>Add unlimited number of spots<br>anywhere on the diagram and<br>customize its colors and size and<br>link it to any webpage.',//the hover content of this spot
		'pos_X':1029,// X position, to get the accurate value, please check the documentation folder.
		'pos_Y':972,// Y position, to get the accurate value, please check the documentation folder.
