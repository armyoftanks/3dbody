var bck_spots = {
	'spots':[
	{
		'hover': '<u><b>EXAMPLE "C"</b></u><br>Add unlimited number of spots<br>anywhere on the diagram and<br>customize its colors and size and<br>link it to any webpage.',//the hover content of this hotspot
		'pos_X':279,// X position, to get the accurate value, please check the documentation folder.
		'pos_Y':508,// Y position, to get the accurate value, please check the documentation folder.
		'diameter':30,// diameter of this spot
		...
		'url':'http://www.humananatomyillustrations.com',// go to this URL
